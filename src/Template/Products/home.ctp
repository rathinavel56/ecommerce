        ...
        <div class="master-slider ms-promo-2" id="promoSlider">
          <div class="ms-slide">
            <img src="<?php echo $actual_link;?>assets/img/blank.gif" alt="Image description"
                 data-src="https://5.imimg.com/data5/UB/BN/DX/SELLER-35697839/chemical-dosing-centrifugal-pump-500x500.jpg">
            ...
            <div class="ms-layer text-center g-absolute-centered g-max-width-550"
             ...
             <!--<img class="ms-thumb" src="https://5.imimg.com/data5/UB/BN/DX/SELLER-35697839/chemical-dosing-centrifugal-pump-500x500.jpg" alt="Image description">-->
          </div>

          <div class="ms-slide">
            <img src="<?php echo $actual_link;?>assets/img/blank.gif" alt="Image description"
                 data-src="https://5.imimg.com/data5/VG/AT/CI/SELLER-35697839/light-horizontal-single-stage-centrifugal-pump-500x500.jpg">
            ...
            <div class="ms-layer text-center g-absolute-centered g-max-width-550"
             ...
             <!--<img class="ms-thumb" src="https://5.imimg.com/data5/VG/AT/CI/SELLER-35697839/light-horizontal-single-stage-centrifugal-pump-500x500.jpg" alt="Image description">-->
          </div>
        </div>
      </section>
      <!-- End Section Content -->
			...
			<?php 
				...
				<div class="col-md-6 col-lg-4 g-mb-30">
				  ...
				  <article class="g-pos-rel">
					<!-- Article Image -->
					<img class="w-100 d-block g-rounded-top-5 homeProductImg" src="https://5.imimg.com/data5/NC/OI/HC/SELLER-35697839/end-suction-centrifugal-pump-500x500.jpg" alt="Image description">
					<!-- End Article Image -->
